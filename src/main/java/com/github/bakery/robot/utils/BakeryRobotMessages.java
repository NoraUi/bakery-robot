...
public class BakeryRobotMessages extends Messages {

    /**
     * Technical messages
     */
    public static final String BAKERYROBOT_ERROR_MESSAGE_DEFAULT = "Erreur dans le code BakeryRobot : ";
